...
public:
	...
	virtual bool intersectLine(Line line, sf::Vector2f& intersectionPoint, sf::Vector2f& intersectionNormal) const = 0;
	virtual bool intersectLineSegment(LineSegment lineSegment) const = 0;
	virtual bool intersectLineSegment(LineSegment lineSegment, sf::Vector2f& intersectionPoint) const = 0;
	virtual bool intersectLineSegment(LineSegment lineSegment, sf::Vector2f& intersectionPoint, sf::Vector2f& intersectionNormal) const = 0;
	virtual bool intersectRay(Ray ray) const = 0;
	virtual bool intersectRay(Ray ray, sf::Vector2f& intersectionPoint) const = 0;
	virtual bool intersectRay(Ray ray, sf::Vector2f& intersectionPoint, sf::Vector2f& intersectionNormal) const = 0;
	virtual bool intersectCircle(float radius, LineSegment displacement) const = 0;
	virtual bool intersectCircle(float radius, LineSegment displacement, sf::Vector2f& centerAfterCollision) const = 0;
	virtual bool intersectCircle(float radius, LineSegment displacement, sf::Vector2f& centerAfterCollision, sf::Vector2f& intersectionPoint) const = 0;
	virtual bool intersectCircle(float radius, LineSegment displacement, sf::Vector2f& centerAfterCollision, sf::Vector2f& intersectionPoint, sf::Vector2f& intersectionNormal) const = 0;
...
public:
	...
	bool intersectLine(Line line, sf::Vector2f& intersectionPoint, sf::Vector2f& intersectionNormal) const override;
	...
	bool intersectLineSegment(LineSegment lineSegment, sf::Vector2f& intersectionPoint, sf::Vector2f& intersectionNormal) const override;
	bool intersectRay(Ray ray) const override;
	bool intersectRay(Ray ray, sf::Vector2f& intersectionPoint) const override;
	bool intersectRay(Ray ray, sf::Vector2f& intersectionPoint, sf::Vector2f& intersectionNormal) const override;
...
public:
	...
	PhysicalPolygon(std::vector<sf::Vector2f> vertices) :
